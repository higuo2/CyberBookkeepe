...
export const cream = {
  page: "h-full overflow-y-auto overscroll-contain bg-[#FAF6EC] px-5 pb-6 pt-[calc(env(safe-area-inset-top)+12px)] touch-pan-y",
  ...
  card: "rounded-3xl border border-[#EFE5D3] bg-white p-5 shadow-sm",
  cardSoft: "rounded-2xl border border-[#EFE5D3] bg-white p-4 shadow-sm",
  iconBtn:
    "grid size-11 place-items-center rounded-full border border-[#EFE5D3] bg-white text-[#8A7A5C] shadow-sm transition-all active:scale-95 disabled:opacity-50",
  field:
